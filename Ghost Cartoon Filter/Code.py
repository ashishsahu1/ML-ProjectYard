...
array = cv2.bitwise_xor(image, image_edge)     #taking xor between image and image_edge to get ghost cartoon filter
...
plt.savefig("(Ghost Cartoon Filtered)"+filename)
plt.show()  #real ghost cartoon filtered photo
