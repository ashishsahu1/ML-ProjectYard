...
Screen Shot of the Model : [SS](images/ss.png)


# To Run Model in :
1. Download all requirements 
2. Download The Dataset : [Here](https://gist.github.com/aaronpolhamus/964a4411c0906315deb9f4a3723aac57) This step is not compulsary if you wish to download the Trained model directly.
